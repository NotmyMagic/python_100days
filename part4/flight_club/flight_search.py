...
FLIGHT_ENDPOINT = "https://test.api.amadeus.com/v1/reference-data/shopping/flight-offers"
...
class FlightSearch:
    ...
    def check_flights(self, origin_city_code, destination_city_code, departure_date):
        headers = {"Authorization": f"Bearer {self._token}"}
        query = {
